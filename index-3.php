			...
			<div class="container">
				<div class="ft-header-top-content d-flex justify-content-between align-items-center">
					<div class="ft-header-top-cta ul-li">
						<ul>
							<li><i class="fal fa-envelope"></i>www.dnlglobe.com</li>
							<li><i class="fal fa-map-marker-alt"></i>Villa No.102, Street 150, Sangkat Phsar Depo I, Khan Toulkork, Phnom Penh, Cambodia.
					...
					<div class="ft-header-main-menu d-flex align-items-center justify-content-between position-relative">
						<div class="ft-site-logo-area">
							<div class="ft-site-logo position-relative">
								<a href="index.html"><img src="assets/img/logo/dnl01-1@2x.png" alt=""></a>
							</div>
						</div>
...
<!-- Start of banner section
	============================================= -->
	<section id="ft-banner" class="ft-banner-section"  data-background="assets/img/bg/dnl-blur2.png">
		...
		<div class="container">
			<div class="ft-section-title-2 headline pera-content text-center">
				...
				<h2>The unique qualities that make
					<span>DNL Logistics</span> special.
				</h2>
			</div>
...
<!-- Start of Service section
	...
	<section id="ft-service-2" class="ft-service-section-2 position-relative">
		<span class="ft-service-bg position-absolute"> <img src="https://static.vecteezy.com/system/resources/previews/010/794/273/original/high-resolution-green-map-of-the-world-vector.jpg" style="width:1920px; height:914px;" alt=""></span>
		<div class="container">
			<div class="ft-section-title-2 headline pera-content text-center">
			...
			<div class="ft-service-content-2">
				<div class="ft-service-slider-2">
					<div class="ft-item-innerbox">
						<div class="ft-service-innerbox-2 position-relative">
							<div class="ft-service-img text-center">
								<img src="https://html.themexriver.com/fastrans/assets/img/service/ser4.3.jpg" alt="">
							</div>
					...
					<div class="ft-item-innerbox">
						<div class="ft-service-innerbox-2 position-relative">
							<div class="ft-service-img text-center">
								<img src="https://html.themexriver.com/fastrans/assets/img/service/ser4.4.jpg" alt="">
							</div>
							<div class="ft-service-text position-relative headline">
								<div class="ft-service-icon position-absolute d-flex align-items-center justify-content-center">
					...
					<div class="ft-item-innerbox">
						<div class="ft-service-innerbox-2 position-relative">
							<div class="ft-service-img text-center">
								<img src="https://html.themexriver.com/fastrans/assets/img/service/ser4.2.jpg" alt="">
							</div>
							<div class="ft-service-text position-relative headline">
								<div class="ft-service-icon position-absolute d-flex align-items-center justify-content-center">
					...
					<div class="col-lg-6 wow fadeInRight" data-wow-delay="600ms" data-wow-duration="1500ms">
						<div class="ft-about-img-2-wrapper position-relative">
							...
							<div class="ft-about-img-2">
								<img src="https://html.themexriver.com/fastrans/assets/img/about/ab2.jpg" alt="">
							</div>
						</div>
					</div>
				</div>
						...
						<div class="ft-experience-circle-progress">
							<div class="row">
								<div class="col-lg-4">
									<div class="counter-boxed text-center headline position-relative">
										<div class="graph-outer">
											<input type="text" class="dial" data-fgColor="#00570E" data-bgColor="#fff" data-width="80" data-height="80" data-linecap="round"  value="95" >
								...
								<div class="col-lg-4">
									<div class="counter-boxed text-center headline position-relative">
										<div class="graph-outer">
											<input type="text" class="dial" data-fgColor="#00570E" data-bgColor="#fff" data-width="80" data-height="80" data-linecap="round"  value="85" >
								...
								<div class="col-lg-4">
									<div class="counter-boxed text-center headline position-relative">
										<div class="graph-outer">
											<input type="text" class="dial" data-fgColor="#00570E" data-bgColor="#fff" data-width="80" data-height="80" data-linecap="round"  value="90" >
		...
		<div class="ft-portfolio-content-2">
			<div class="ft-portfolio-slider-2">
				<div class="ft-portfolio-slider-item">
					<div class="ft-portfolio-slider-innerbox position-relative">
						<div class="ft-portfolio-img">
							<img src="https://html.themexriver.com/fastrans/assets/img/project/port1.jpg" alt="">
						</div>
				...
				<div class="ft-portfolio-slider-item">
					<div class="ft-portfolio-slider-innerbox position-relative">
						<div class="ft-portfolio-img">
							<img src="https://html.themexriver.com/fastrans/assets/img/project/port2.jpg" alt="">
						</div>
						<div class="ft-portfolio-text headline headline pera-content">
							<h3><a href="project-single.html">Service & Aftermarket
							Logistics</a></h3>
				...
				<div class="ft-portfolio-slider-item">
					<div class="ft-portfolio-slider-innerbox position-relative">
						<div class="ft-portfolio-img">
							<img src="https://html.themexriver.com/fastrans/assets/img/project/port3.jpg" alt="">
						</div>
						<div class="ft-portfolio-text headline headline pera-content">
							<h3><a href="project-single.html">Service & Aftermarket
							Logistics</a></h3>
				...
				<div class="ft-portfolio-slider-item">
					<div class="ft-portfolio-slider-innerbox position-relative">
						<div class="ft-portfolio-img">
							<img src="https://html.themexriver.com/fastrans/assets/img/project/port4.jpg" alt="">
						</div>
						<div class="ft-portfolio-text headline headline pera-content">
							<h3><a href="project-single.html">Service & Aftermarket
							Logistics</a></h3>
							...
							<li class="current_item">
								<div class="ft-testimonial-innerbox-item-2 text-center">
									<div class="ft-testimonial-img">
										<img src="https://html.themexriver.com/fastrans/assets/img/testimonial/test2.1.jpg" alt="">
									</div>
					...
					<div class="col-lg-6">
						<div class="ft-why-choose-content-2">
							<div class="ft-section-title-2 headline pera-content wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
								...
								<h2>Why You Like DNL Dynamical Network Logistics?</h2>
							</div>
							<div class="ft-why-choose-feature-wrapper-2">
								<div class="row">
									...
									<div class="col-lg-6 wow fadeInUp" data-wow-delay="800ms" data-wow-duration="1500ms">
										<div class="ft-why-choose-feature-list-item-2">
											<div class="ft-why-choose-feature-icon">
												<i class="flaticon-free-shipping"></i>
											</div>
			...
			<div class="ft-blog-content-2">
				<div class="ft-blog-slider-2">
					<div class="ft-item-innerbox">
						<div class="ft-blog-innerbox-2">
							<div class="ft-blog-img-2 position-relative">
								<img src="https://html.themexriver.com/fastrans/assets/img/blog/blg2.1.jpg" alt="">
					...
					<div class="ft-item-innerbox">
						<div class="ft-blog-innerbox-2">
							<div class="ft-blog-img-2 position-relative">
								<img src="https://html.themexriver.com/fastrans/assets/img/blog/blg2.2.jpg" alt="">
								<div class="ft-blog-meta text-center d-flex align-items-center justify-content-center position-absolute">
									21 Oct
								</div>
							</div>
					...
					<div class="ft-item-innerbox">
						<div class="ft-blog-innerbox-2">
							<div class="ft-blog-img-2 position-relative">
								<img src="https://html.themexriver.com/fastrans/assets/img/blog/blg2.3.jpg" alt="">
								<div class="ft-blog-meta text-center d-flex align-items-center justify-content-center position-absolute">
									21 Oct
								</div>
							</div>
...
<!-- Start of Footer   section
	...
	<footer id="ft-footer-2" class="ft-footer-section-2" data-background="assets/img/bg/background.png">
						...
						<div class="ft-footer-widget ul-li-block headline pera-content">
							<div class="logo-widget">
								...
								<div class="ft-footer-address">
									<span>Villa No.102, Street 150, Sangkat Phsar Depo I, Khan Toulkork, Phnom Penh, Cambodia.</span>
									<span>Website: www.dnlglobe.com</span>
									<span>Email: dnl@mail.com</span>
									<span>Phone:+855-89-666 565 | +855-81-666 565</span>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="ft-footer-copywrite-2 text-center">
			<span>Copyright @ 2021 DNL Dynamical Network Logistics.All Rights Reserved</span>
		</div>
	</footer>		
<!-- End of FAQ why choose  section
	============================================= -->
